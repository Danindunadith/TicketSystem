        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 mb-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Ticket Hub</h2>
                <p className="text-blue-200 text-sm">AssignoZ</p>
              </div>
            </div>
            ...
            <p className="text-blue-200 text-sm leading-relaxed">
              Assignoz Consultancy provides expert Leading service provider
            </p>
          </div>
          ...
          <div className="w-full md:w-1/4 mb-8">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold mb-2 text-white">Mobile Number</h4>
                <p className="text-blue-200">+94 724543336</p>
              </div>
              <div>
                <h4 className="font-semibold mb-2 text-white">Email</h4>
                <p className="text-blue-200">infoassignoz@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
